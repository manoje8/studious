...
from medici.common.utils.constants import StorageType
...
class TestGoogleCloudStorage:
    ...
    def mock_gcs(self):
        ...
        with (
            ...
            patch("medici.common.storage.gcp_storage.config") as mock_config,
        ):
...
class TestStorageFactory:
    ...
    #     }
    #
    #     with patch("medici.common.storage.gcp_storage.config") as mock_config:
    #         mock_config.PROJECT_ID = "test-project"
    #         storage = StorageFactory.create(config)
