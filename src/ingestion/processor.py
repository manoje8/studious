...
def parse_args():
    ...
    parser.add_argument(
        "--parse-method", type=str, default=None,
        help="Parsing method (passed to underlying parser)."
    )
    parser.add_argument(
        "--display-stats", action="store_true",
        help="Show statistics about extracted content blocks."
    )
    parser.add_argument(
        "--split-by-character", type=str, default=None,
        help="Character to split content by (passed via **kwargs)."
    )
    parser.add_argument(
        "--split-by-character-only", type=str, default=None,
